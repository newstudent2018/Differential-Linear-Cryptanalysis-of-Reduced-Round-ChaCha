...
// 1/4QR function
#define HALF_1_QUARTER_of_QUARTERROUND(a, b, c, d) \
a = PLUS(a, b);              \
d = ROTATE(XOR(d, a), 16);   \

#define HALF_2_QUARTER_of_QUARTERROUND(a, b, c, d) \
c = PLUS(c, d);              \
b = ROTATE(XOR(b, c), 12);   \

#define HALF_3_QUARTER_of_QUARTERROUND(a, b, c, d) \
a = PLUS(a, b);              \
d = ROTATE(XOR(d, a), 8);    \

#define HALF_4_QUARTER_of_QUARTERROUND(a, b, c, d) \
c = PLUS(c, d);              \
b = ROTATE(XOR(b, c), 7);\
...
#define HALF_1_INVERT_QUARTERROUND(a, b, c, d) \
b = XOR(ROTATE(b,20), c); \
c = MINUS(c, d);              \
d = XOR(ROTATE(d,16), a); \
a = MINUS(a, b);

#define HALF_2_INVERT_QUARTERROUND(a, b, c, d) \
b = XOR(ROTATE(b,25), c); \
c = MINUS(c, d);              \
d = XOR(ROTATE(d,24), a); \
a = MINUS(a, b);              \
...
#define HALF_1_INVERT_QUARTER_of_QUARTERROUND(a, b, c, d) \
d = XOR(ROTATE(d,16), a); \
a = MINUS(a, b);\

#define HALF_2_INVERT_QUARTER_of_QUARTERROUND(a, b, c, d) \
b = XOR(ROTATE(b,20), c); \
c = MINUS(c, d);              \

#define HALF_3_INVERT_QUARTER_of_QUARTERROUND(a, b, c, d) \
d = XOR(ROTATE(d,24), a); \
a = MINUS(a, b);              \

#define HALF_4_INVERT_QUARTER_of_QUARTERROUND(a, b, c, d) \
b = XOR(ROTATE(b,25), c); \
c = MINUS(c, d);              \
...
__host__ __device__ void chacha_odd_quarter_round(uint32_t x[16], int half)
{
	if (half == 1)
	{
		HALF_1_QUARTER_of_QUARTERROUND(x[0], x[4], x[8], x[12])
			HALF_1_QUARTER_of_QUARTERROUND(x[1], x[5], x[9], x[13])
			HALF_1_QUARTER_of_QUARTERROUND(x[2], x[6], x[10], x[14])
			HALF_1_QUARTER_of_QUARTERROUND(x[3], x[7], x[11], x[15])
	}
	else if (half == 2)
	{
		HALF_2_QUARTER_of_QUARTERROUND(x[0], x[4], x[8], x[12])
			HALF_2_QUARTER_of_QUARTERROUND(x[1], x[5], x[9], x[13])
			HALF_2_QUARTER_of_QUARTERROUND(x[2], x[6], x[10], x[14])
			HALF_2_QUARTER_of_QUARTERROUND(x[3], x[7], x[11], x[15])
	}
	else if (half == 3)
	{
		HALF_3_QUARTER_of_QUARTERROUND(x[0], x[4], x[8], x[12])
			HALF_3_QUARTER_of_QUARTERROUND(x[1], x[5], x[9], x[13])
			HALF_3_QUARTER_of_QUARTERROUND(x[2], x[6], x[10], x[14])
			HALF_3_QUARTER_of_QUARTERROUND(x[3], x[7], x[11], x[15])
	}
	else if (half == 4)
	{
		HALF_4_QUARTER_of_QUARTERROUND(x[0], x[4], x[8], x[12])
			HALF_4_QUARTER_of_QUARTERROUND(x[1], x[5], x[9], x[13])
			HALF_4_QUARTER_of_QUARTERROUND(x[2], x[6], x[10], x[14])
			HALF_4_QUARTER_of_QUARTERROUND(x[3], x[7], x[11], x[15])
	}
}


__host__ __device__ void chacha_odd_INVERT_quarter_round(uint32_t x[16], int half)
{
	if (half == 1)
	{
		HALF_1_INVERT_QUARTER_of_QUARTERROUND(x[0], x[4], x[8], x[12])
			HALF_1_INVERT_QUARTER_of_QUARTERROUND(x[1], x[5], x[9], x[13])
			HALF_1_INVERT_QUARTER_of_QUARTERROUND(x[2], x[6], x[10], x[14])
			HALF_1_INVERT_QUARTER_of_QUARTERROUND(x[3], x[7], x[11], x[15])
	}
	else if (half == 2)
	{
		HALF_2_INVERT_QUARTER_of_QUARTERROUND(x[0], x[4], x[8], x[12])
			HALF_2_INVERT_QUARTER_of_QUARTERROUND(x[1], x[5], x[9], x[13])
			HALF_2_INVERT_QUARTER_of_QUARTERROUND(x[2], x[6], x[10], x[14])
			HALF_2_INVERT_QUARTER_of_QUARTERROUND(x[3], x[7], x[11], x[15])
	}
	else if (half == 3)
	{
		HALF_3_INVERT_QUARTER_of_QUARTERROUND(x[0], x[4], x[8], x[12])
			HALF_3_INVERT_QUARTER_of_QUARTERROUND(x[1], x[5], x[9], x[13])
			HALF_3_INVERT_QUARTER_of_QUARTERROUND(x[2], x[6], x[10], x[14])
			HALF_3_INVERT_QUARTER_of_QUARTERROUND(x[3], x[7], x[11], x[15])
	}
	else if (half == 4)
	{
		HALF_4_INVERT_QUARTER_of_QUARTERROUND(x[0], x[4], x[8], x[12])
			HALF_4_INVERT_QUARTER_of_QUARTERROUND(x[1], x[5], x[9], x[13])
			HALF_4_INVERT_QUARTER_of_QUARTERROUND(x[2], x[6], x[10], x[14])
			HALF_4_INVERT_QUARTER_of_QUARTERROUND(x[3], x[7], x[11], x[15])
	}
}
...
__host__ __device__ void chacha_even_quarter_round(uint32_t x[16], int half)
{
	if (half == 1)
	{
		HALF_1_QUARTER_of_QUARTERROUND(x[0], x[5], x[10], x[15])
			HALF_1_QUARTER_of_QUARTERROUND(x[1], x[6], x[11], x[12])
			HALF_1_QUARTER_of_QUARTERROUND(x[2], x[7], x[8], x[13])
			HALF_1_QUARTER_of_QUARTERROUND(x[3], x[4], x[9], x[14])
	}
	else if (half == 2)
	{
		HALF_2_QUARTER_of_QUARTERROUND(x[0], x[5], x[10], x[15])
			HALF_2_QUARTER_of_QUARTERROUND(x[1], x[6], x[11], x[12])
			HALF_2_QUARTER_of_QUARTERROUND(x[2], x[7], x[8], x[13])
			HALF_2_QUARTER_of_QUARTERROUND(x[3], x[4], x[9], x[14])
	}
	else if (half == 3)
	{
		HALF_3_QUARTER_of_QUARTERROUND(x[0], x[5], x[10], x[15])
			HALF_3_QUARTER_of_QUARTERROUND(x[1], x[6], x[11], x[12])
			HALF_3_QUARTER_of_QUARTERROUND(x[2], x[7], x[8], x[13])
			HALF_3_QUARTER_of_QUARTERROUND(x[3], x[4], x[9], x[14])
	}
	else if (half == 4)
	{
		HALF_4_QUARTER_of_QUARTERROUND(x[0], x[5], x[10], x[15])
			HALF_4_QUARTER_of_QUARTERROUND(x[1], x[6], x[11], x[12])
			HALF_4_QUARTER_of_QUARTERROUND(x[2], x[7], x[8], x[13])
			HALF_4_QUARTER_of_QUARTERROUND(x[3], x[4], x[9], x[14])
	}
}



__host__ __device__ void chacha_even_INVERT_quarter_round(uint32_t x[16], int half)
{
	if (half == 1)
	{
		HALF_1_INVERT_QUARTER_of_QUARTERROUND(x[0], x[5], x[10], x[15])
			HALF_1_INVERT_QUARTER_of_QUARTERROUND(x[1], x[6], x[11], x[12])
			HALF_1_INVERT_QUARTER_of_QUARTERROUND(x[2], x[7], x[8], x[13])
			HALF_1_INVERT_QUARTER_of_QUARTERROUND(x[3], x[4], x[9], x[14])
	}
	else if (half == 2)
	{
		HALF_2_INVERT_QUARTER_of_QUARTERROUND(x[0], x[5], x[10], x[15])
			HALF_2_INVERT_QUARTER_of_QUARTERROUND(x[1], x[6], x[11], x[12])
			HALF_2_INVERT_QUARTER_of_QUARTERROUND(x[2], x[7], x[8], x[13])
			HALF_2_INVERT_QUARTER_of_QUARTERROUND(x[3], x[4], x[9], x[14])
	}
	else if (half == 3)
	{
		HALF_3_INVERT_QUARTER_of_QUARTERROUND(x[0], x[5], x[10], x[15])
			HALF_3_INVERT_QUARTER_of_QUARTERROUND(x[1], x[6], x[11], x[12])
			HALF_3_INVERT_QUARTER_of_QUARTERROUND(x[2], x[7], x[8], x[13])
			HALF_3_INVERT_QUARTER_of_QUARTERROUND(x[3], x[4], x[9], x[14])
	}
	else if (half == 4)
	{
		HALF_4_INVERT_QUARTER_of_QUARTERROUND(x[0], x[5], x[10], x[15])
			HALF_4_INVERT_QUARTER_of_QUARTERROUND(x[1], x[6], x[11], x[12])
			HALF_4_INVERT_QUARTER_of_QUARTERROUND(x[2], x[7], x[8], x[13])
			HALF_4_INVERT_QUARTER_of_QUARTERROUND(x[3], x[4], x[9], x[14])
	}
}
...
__host__ __device__ void chacha_rounds_withquarter(uint32_t state[16], uint32_t rounds, uint32_t lastRound, uint32_t fronthalf, uint32_t lasthalf)
{
	uint32_t i;
	...
	if (fronthalf == 1)
	{
		if (lastRound % 2)
		{
			chacha_odd_quarter_round(state, 2);
			chacha_odd_quarter_round(state, 3);
			chacha_odd_quarter_round(state, 4);
		}
		else
		{
			chacha_even_quarter_round(state, 2);
			chacha_even_quarter_round(state, 3);
			chacha_even_quarter_round(state, 4);
		}
	}
	else if (fronthalf == 2)
	{
	...
	if (lasthalf == 1)
	{
		if ((rounds + lastRound + 1) % 2)
		{
			chacha_odd_quarter_round(state, 1);
		}
		else
		{
			chacha_even_quarter_round(state, 1);
		}
	}
	else if (lasthalf == 2)
	{
...
__host__ __device__ void chacha_invert_rounds_withquarter(uint32_t state[16], uint32_t rounds, uint32_t lastRound, uint32_t fronthalf, uint32_t lasthalf)
{
	...
	if (lasthalf == 1)
	{
		if ((lastRound + 1) % 2)
		{
			chacha_odd_INVERT_quarter_round(state, 1);
		}
		else
		{
			chacha_even_INVERT_quarter_round(state, 1);
		}
	}
	else if (lasthalf == 2)
	{
		if ((lastRound + 1) % 2)
		{
			chacha_odd_INVERT_quarter_round(state, 2);
			chacha_odd_INVERT_quarter_round(state, 1);
		}
		else
		{
			chacha_even_INVERT_quarter_round(state, 2);
			chacha_even_INVERT_quarter_round(state, 1);
		}
	}
	else if (lasthalf == 3)
	{
		if ((lastRound + 1) % 2)
		{
			chacha_odd_INVERT_quarter_round(state, 3);
			chacha_odd_INVERT_quarter_round(state, 2);
			chacha_odd_INVERT_quarter_round(state, 1);
		}
		else
		{
			chacha_even_INVERT_quarter_round(state, 3);
			chacha_even_INVERT_quarter_round(state, 2);
			chacha_even_INVERT_quarter_round(state, 1);
		}
	}
	...
	if (fronthalf == 1)
	{
		if ((lastRound - rounds) % 2)
		{
			chacha_odd_INVERT_quarter_round(state, 4);
			chacha_odd_INVERT_quarter_round(state, 3);
			chacha_odd_INVERT_quarter_round(state, 2);
		}
		else
		{
			chacha_even_INVERT_quarter_round(state, 4);
			chacha_even_INVERT_quarter_round(state, 3);
			chacha_even_INVERT_quarter_round(state, 2);
		}
	}
...
__host__ __device__ void chacha_encrypt_withquarter(uint32_t output[16], uint32_t input[16], uint32_t rounds, uint32_t lasthalf)
{
	uint32_t x[16];
	uint32_t i;
	...
	chacha_rounds_withquarter(x, rounds, 0, 0, lasthalf);
...
__host__ __device__ void chacha_invert_withquarter(uint32_t output[16], uint32_t input[16], uint32_t intermediate[16], uint32_t rounds, uint32_t lastRound, uint32_t fronthalf, uint32_t lasthalf)
{
	for (int i = 0; i < 16; ++i) intermediate[i] = MINUS(output[i], input[i]);

	chacha_invert_rounds_withquarter(intermediate, rounds, lastRound, fronthalf, lasthalf);
}
...
typedef struct {
	...
	void(*encrypt_withquarter)(uint32_t *, uint32_t *, uint32_t, uint32_t);
	void(*invert_withquarter)(uint32_t *, uint32_t *, uint32_t *, uint32_t, uint32_t, uint32_t, uint32_t);
...
__host__ __device__ void define_alg(ALGORITHM *alg, uint32_t type)
{
	...
	case ALG_TYPE_CHACHA:
		...
		alg->encrypt_withquarter = &chacha_encrypt_withquarter;
		alg->invert = &chacha_invert;
		alg->invert_withquarter = &chacha_invert_withquarter;
...
)
{
	...
	for (int t = 0; t < ntestForEachThread; t++)
	{
		...
		//encrypt 7.25-round ChaCha
		alg.encrypt_withquarter(final_state, state, enc_rounds, 1);
		alg.encrypt_withquarter(alt_final_state, alt_state, enc_rounds, 1);

		//decrypt 2.25-round ChaCha
		alg.invert_withquarter(final_state, state, intermediate_state, dec_rounds, enc_rounds, 0, 1);
		alg.invert_withquarter(alt_final_state, alt_state, alt_intermediate_state, dec_rounds, enc_rounds, 0, 1);
		...
		//decrypt 2.25-round ChaCha with PNBs
		alg.invert_withquarter(final_state, state, intermediate_state, dec_rounds, enc_rounds, 0, 1);
		alg.invert_withquarter(alt_final_state, alt_state, alt_intermediate_state, dec_rounds, enc_rounds, 0, 1);
...
void main()
{
	...
	double varepsilon_d = 0.00317;
	
	N = 1;
	N <<= 28;

	//133 PNBs are used.
	uint32_t pnb[133] = { 20, 31, 44, 45, 46, 55, 56, 57, 58, 59, 60, 61, 62, 63, 64, 65, 66, 67, 68, 71, 72, 73, 74, 77, 80, 83, 84, 85,
		86, 89, 90, 95, 99, 108, 109, 123, 124, 125, 126, 127, 128, 129, 140, 141, 152, 153, 154, 155, 156, 157, 158, 159, 160, 161, 162,
		163, 164, 165, 166, 167, 168, 169, 170, 171, 172, 173, 174, 175, 176, 177, 178, 179, 180, 181, 182, 183, 184, 185, 186, 187, 188,
		189, 190, 191, 192, 193, 194, 198, 199, 200, 204, 205, 206, 207, 210, 211, 218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 244,
		245, 246, 247, 255, 142, 47, 21, 248, 110, 7, 8, 130, 91, 212, 100, 231, 111, 232, 143, 22, 48, 249, 51, 35, 81, 0 };
	number_of_pnb = 133;
